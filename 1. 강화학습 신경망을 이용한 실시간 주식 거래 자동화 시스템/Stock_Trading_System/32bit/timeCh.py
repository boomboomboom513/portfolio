...
class timeChange:
    ...
    def yesterdatTimeDay(self):
        if self.getTime.month >= 10:
            if self.getTime.day >= 10:
                dy = str(self.getTime.year)+str(self.getTime.month)+str(int(self.getTime.day)-1)
            else:
                dy = str(self.getTime.year)+str(self.getTime.month)+'0'+str(int(self.getTime.day)-1)
        else:
            if self.getTime.day >= 10:
                dy = str(self.getTime.year)+'0'+str(self.getTime.month)+str(int(self.getTime.day)-1)
            else:
                dy = str(self.getTime.year)+'0'+str(self.getTime.month)+'0'+str(int(self.getTime.day)-1)
